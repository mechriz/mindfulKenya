...
const bookAppointment = async (req, res) => {
    ...
    try {
        ...
        const docData = await therapistModel.findById(docId).select("-password")
        ...
        await therapistModel.findByIdAndUpdate(docId, { slots_booked })
...
const cancelAppointment = async (req, res) => {
    try {
        ...
        const therapistData = await therapistModel.findById(docId)
