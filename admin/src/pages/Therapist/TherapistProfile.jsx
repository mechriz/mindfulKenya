...
const TherapistProfile = () => {
    ...
    const { dToken, profileData, setProfileData, getProfileData } = useContext(TherapistContext)
    ...
    const updateProfile = async () => {
        ...
        try {
            ...
            const { data } = await axios.post(backendUrl + '/api/therapist/update-profile', updateData, { headers: { dToken } })
